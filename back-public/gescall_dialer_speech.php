<?php
// gescall_dialer.php - Sync Dialer with CallerID & Speech Support
...
$speech = isset($_REQUEST['speech']) ? $_REQUEST['speech'] : '';

// USE 8301 for Universal TTS
$agent_ext = '8301'; 
...
// If Speech provided
if (!empty($speech)) {
    fputs($socket, "Variable: TTS_TEXT=$speech\r\n");
}
