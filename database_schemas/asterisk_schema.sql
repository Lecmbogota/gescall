...
--
-- Table structure for table `cid_channels_recent_072251005057`
--

DROP TABLE IF EXISTS `cid_channels_recent_072251005057`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cid_channels_recent_072251005057` (
  `caller_id_name` varchar(30) NOT NULL,
  `connected_line_name` varchar(30) NOT NULL,
  `call_date` datetime DEFAULT NULL,
  `channel` varchar(100) DEFAULT '',
...
--
-- Table structure for table `cid_channels_recent_072251005061`
--

DROP TABLE IF EXISTS `cid_channels_recent_072251005061`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cid_channels_recent_072251005061` (
  `caller_id_name` varchar(30) NOT NULL,
  `connected_line_name` varchar(30) NOT NULL,
  `call_date` datetime DEFAULT NULL,
  `channel` varchar(100) DEFAULT '',
...
--
-- Table structure for table `cid_channels_recent_209038233046`
--

DROP TABLE IF EXISTS `cid_channels_recent_209038233046`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `cid_channels_recent_209038233046` (
  `caller_id_name` varchar(30) NOT NULL,
  `connected_line_name` varchar(30) NOT NULL,
  `call_date` datetime DEFAULT NULL,
  `channel` varchar(100) DEFAULT '',
...
--
-- Table structure for table `crashed_tables`
--

DROP TABLE IF EXISTS `crashed_tables`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `crashed_tables` (
  `table_name` varchar(100) NOT NULL,
  `crashed_datetime` datetime DEFAULT NULL,
...
--
-- Table structure for table `gescall_api_keys`
--

DROP TABLE IF EXISTS `gescall_api_keys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_api_keys` (
...
--
-- Table structure for table `gescall_call_log`
--

DROP TABLE IF EXISTS `gescall_call_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_call_log` (
  ...
  `call_status` enum('DIALING','RINGING','ANSWER','HANGUP','CANCEL','FAILED','XFER','IVR_START','NO_ANSWER') DEFAULT 'DIALING',
  `dtmf_pressed` varchar(10) DEFAULT NULL COMMENT 'DTMF pressed by the customer',
  `call_duration` int(10) unsigned DEFAULT 0 COMMENT 'Duration in seconds',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_lead_call` (`lead_id`,`call_date`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1113092 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `gescall_callerid_pool_numbers`
--

DROP TABLE IF EXISTS `gescall_callerid_pool_numbers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_callerid_pool_numbers` (
  ...
  `rr_order` int(11) DEFAULT 0 COMMENT 'Round-robin order counter',
  `created_at` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_pool_callerid` (`pool_id`,`callerid`),
  KEY `idx_selection` (`pool_id`,`area_code`,`is_active`,`rr_order`),
  KEY `idx_area_code` (`area_code`),
  KEY `idx_pool_last_used` (`pool_id`,`last_used_at`),
  CONSTRAINT `gescall_callerid_pool_numbers_ibfk_1` FOREIGN KEY (`pool_id`) REFERENCES `gescall_callerid_pools` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=45010 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `gescall_callerid_pools`
--

DROP TABLE IF EXISTS `gescall_callerid_pools`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_callerid_pools` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `gescall_callerid_usage_log`
--

DROP TABLE IF EXISTS `gescall_callerid_usage_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_callerid_usage_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `campaign_id` varchar(20) DEFAULT NULL,
  `lead_id` int(11) DEFAULT NULL,
  `phone_number` varchar(20) DEFAULT NULL COMMENT 'Lead phone number dialed',
  `callerid_used` varchar(20) DEFAULT NULL,
  `area_code_target` char(3) DEFAULT NULL,
  `pool_id` int(11) DEFAULT NULL,
  `selection_result` enum('MATCHED','FALLBACK','DEFAULT') DEFAULT NULL COMMENT 'How the CallerID was selected',
  `strategy` enum('ROUND_ROBIN','RANDOM','LRU') DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_campaign_date` (`campaign_id`,`created_at`),
  KEY `idx_callerid` (`callerid_used`),
  KEY `idx_date` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=241520 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `gescall_campaign_callerid_settings`
--

DROP TABLE IF EXISTS `gescall_campaign_callerid_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_campaign_callerid_settings` (
  `campaign_id` varchar(20) NOT NULL COMMENT 'Vicidial campaign_id',
  ...
  `fixed_area_code` char(3) DEFAULT NULL,
  `fallback_callerid` varchar(20) DEFAULT NULL,
  `selection_strategy` enum('ROUND_ROBIN','RANDOM','LRU') DEFAULT 'ROUND_ROBIN',
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`campaign_id`),
  KEY `idx_pool` (`pool_id`),
  CONSTRAINT `gescall_campaign_callerid_settings_ibfk_1` FOREIGN KEY (`pool_id`) REFERENCES `gescall_callerid_pools` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `gescall_campaign_playback`
--

DROP TABLE IF EXISTS `gescall_campaign_playback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_campaign_playback` (
  `campaign_id` varchar(20) NOT NULL,
...
--
-- Table structure for table `gescall_campaign_status`
--

DROP TABLE IF EXISTS `gescall_campaign_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_campaign_status` (
  `campaign_id` varchar(20) NOT NULL,
...
--
-- Table structure for table `gescall_ivr_executions`
--

DROP TABLE IF EXISTS `gescall_ivr_executions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_ivr_executions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `campaign_id` varchar(20) NOT NULL,
  `lead_id` int(11) DEFAULT NULL,
  ...
  `execution_data` longtext DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `campaign_id` (`campaign_id`),
  KEY `lead_id` (`lead_id`)
) ENGINE=MyISAM AUTO_INCREMENT=428 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `gescall_ivr_flows`
--

DROP TABLE IF EXISTS `gescall_ivr_flows`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_ivr_flows` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `campaign_id` varchar(20) NOT NULL,
...
--
-- Table structure for table `gescall_schedules`
--

DROP TABLE IF EXISTS `gescall_schedules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_schedules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `gescall_tts_nodes`
--

DROP TABLE IF EXISTS `gescall_tts_nodes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_tts_nodes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
--
-- Table structure for table `gescall_upload_tasks`
--

DROP TABLE IF EXISTS `gescall_upload_tasks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_upload_tasks` (
...
--
-- Table structure for table `gescall_whitelist_prefixes`
--

DROP TABLE IF EXISTS `gescall_whitelist_prefixes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `gescall_whitelist_prefixes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `recording_dtmf_log`
--

DROP TABLE IF EXISTS `recording_dtmf_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_dtmf_log` (
  ...
  `dtmf_muting_start_time` datetime DEFAULT NULL,
  `dtmf_muting_end_time` datetime DEFAULT NULL,
  ...
  KEY `dtmf_muting_end_time` (`dtmf_muting_end_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `recording_dtmf_muting_log`
--

DROP TABLE IF EXISTS `recording_dtmf_muting_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_dtmf_muting_log` (
  `dtmf_mute_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `recording_id` int(10) unsigned NOT NULL,
  `recording_type` varchar(40) DEFAULT 'MONO_LEGACY',
  `server_ip` varchar(15) DEFAULT NULL,
  `channel` varchar(255) DEFAULT NULL,
  `channel_to_mute` varchar(255) DEFAULT NULL,
  `filename` varchar(100) DEFAULT NULL,
  `lead_id` int(9) unsigned DEFAULT NULL,
  `campaign_id` varchar(20) DEFAULT '',
...
--
-- Table structure for table `recording_dtmf_muting_log_archive`
--

DROP TABLE IF EXISTS `recording_dtmf_muting_log_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_dtmf_muting_log_archive` (
  `dtmf_mute_id` int(10) unsigned NOT NULL,
  `recording_id` int(10) unsigned NOT NULL,
  `recording_type` varchar(40) DEFAULT 'MONO_LEGACY',
  `server_ip` varchar(15) DEFAULT NULL,
  `channel` varchar(255) DEFAULT NULL,
  ...
  `mute_state` tinyint(3) unsigned DEFAULT 0,
  PRIMARY KEY (`dtmf_mute_id`),
  UNIQUE KEY `rdml_key` (`dtmf_mute_id`,`recording_id`),
  KEY `filename` (`filename`),
  KEY `recording_id` (`recording_id`),
  KEY `dtmf_muting_end_time` (`dtmf_muting_end_time`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
--
-- Table structure for table `recording_live`
--

DROP TABLE IF EXISTS `recording_live`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `recording_live_log`
--

DROP TABLE IF EXISTS `recording_live_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `recording_live_log_archive`
--

DROP TABLE IF EXISTS `recording_live_log_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_live_log_archive` (
  `recording_id` int(10) unsigned NOT NULL,
  `recording_type` varchar(40) DEFAULT 'MONO_LEGACY',
  `server_ip` varchar(15) DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
...
--
-- Table structure for table `recording_log_parallel`
--

DROP TABLE IF EXISTS `recording_log_parallel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_log_parallel` (
  `parallel_recording_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `channel` varchar(100) DEFAULT NULL,
  `server_ip` varchar(15) DEFAULT NULL,
  `extension` varchar(100) DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
  ...
  `recording_status` varchar(20) DEFAULT '',
  `processing_log` text DEFAULT NULL,
  PRIMARY KEY (`parallel_recording_id`),
  KEY `filename` (`filename`),
  KEY `lead_id` (`lead_id`),
  KEY `start_time` (`start_time`),
  KEY `vicidial_id` (`vicidial_id`)
...
--
-- Table structure for table `recording_log_parallel_archive`
--

DROP TABLE IF EXISTS `recording_log_parallel_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_log_parallel_archive` (
  `parallel_recording_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `channel` varchar(100) DEFAULT NULL,
  `server_ip` varchar(15) DEFAULT NULL,
  `extension` varchar(100) DEFAULT NULL,
...
CREATE TABLE `recording_log_stereo` (
  ...
  KEY `lead_id` (`lead_id`),
  KEY `start_time` (`start_time`),
  KEY `parallel_recording_id` (`parallel_recording_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `recording_log_stereo_archive`
--

DROP TABLE IF EXISTS `recording_log_stereo_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `recording_log_stereo_archive` (
  `recording_id` int(10) unsigned NOT NULL,
  `server_ip` varchar(15) DEFAULT NULL,
  `start_time` datetime DEFAULT NULL,
  `end_time` datetime DEFAULT NULL,
...
--
-- Table structure for table `rotatelefonos`
--

DROP TABLE IF EXISTS `rotatelefonos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `rotatelefonos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `system_settings` (
  ...
  `db_crashed_tables_check` varchar(1) DEFAULT 'N'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9675 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3408 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1776269 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_auto_calls` (
  ...
  KEY `date_phone` (`phone_number`)
) ENGINE=InnoDB AUTO_INCREMENT=595419 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_campaigns` (
  ...
  `call_count_limit_restrict` enum('DISABLED','RESTRICT_ALL') DEFAULT 'DISABLED',
  `adaptive_percentmax_percentage` varchar(4) DEFAULT '90',
  PRIMARY KEY (`campaign_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30981 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_hopper` (
  ...
  KEY `lead_id` (`lead_id`)
) ENGINE=InnoDB AUTO_INCREMENT=725751 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1000000 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_ivr_response` (
  ...
  KEY `lead_id` (`lead_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1599 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5848875 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_live_agents` (
  ...
  KEY `vlali` (`lead_id`),
  KEY `vlaus` (`user`)
) ENGINE=InnoDB AUTO_INCREMENT=6358 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9725054 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_peer_event_log` (
  ...
  KEY `peer` (`peer`),
  KEY `channel` (`channel`)
) ENGINE=InnoDB AUTO_INCREMENT=743452 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vicidial_recording_access_log` (
  ...
  KEY `recording_id` (`recording_id`),
  KEY `lead_id` (`lead_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1599 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1403 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3119 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-28 19:00:00
